...
public class ScreenStreamingService extends AccessibilityService {
    ...
    public static Intent getStartIntent(Context context, int resultCode, Intent data) {
        Intent intent = new Intent(context, ScreenStreamingService.class);
    ...
    private class ImageAvailableListener implements ImageReader.OnImageAvailableListener {
        ...
        public void onImageAvailable(ImageReader reader) {
            if(action.actionHandler(steps, reader, ScreenStreamingService.this, mWidth, mHeight, imageView, appOpened, source)){
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        action = new Action(getApplicationContext(), ScreenStreamingService.this);
        if (intent != null) {
            json = intent.getExtras().get("json").toString();
            steps = bindStep(json);
        }
